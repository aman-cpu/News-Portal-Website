...
if(isset($_POST['save'])){
    ...
    if(mysqli_num_rows($result)>0){
        echo "<center><p style='margin-top: 10px;color:red;'>Username already exist</p></center>";
    }else{
        $sql1="INSERT INTO `user` (fname,lname,uname,password,role) VALUES ('{$fname}','{$lname}','{$uname}','{$password}','{$role}')";
...
<body>
    <div class="signup-form">
        <form action="<?php $_SERVER['PHP_SELF']?>" method="post">
            ...
            <div class="form-group">
                <input type="submit" value="Add" name="save" class="btn btn-success btn-lg btn-block">
            </div>
        </form>
