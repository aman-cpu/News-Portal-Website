...
<body>
    ...
    <div class="container">
        ...
        if(isset($_GET['aid'])){
            ...
            ?>
        <div>
            <h2 style="border-bottom: 3px solid black;"><?php echo $row1['uname'];?></h2>    
        </div>
        <?php
        $limit = 3;
        if (isset($_GET['page'])) {
    ...
    if (mysqli_num_rows($result1) > 0) {
        ...
        if ($page > 1) {
            echo '<li class="page-item"><a style="margin: 0 7px;" class="page-link" href="author.php?aid='.$auth_id.'&page='.($page-1).'">Previous</a></li>';
        }
        for ($i = 1; $i <=$total_page; $i++) {
            ...
            echo '<li class="page-item ' . $active . '"><a style="margin: 0 7px;"  class="page-link" href="author.php?aid='.$auth_id.'&page=' . $i . '">' . $i . '</a></li>';
        }
        if ($total_page > $page) {
            echo '<li class="page-item"><a style="margin: 0 7px;"  class="page-link" href="author.php?aid='.$auth_id.'&page='.($page+1).'">Next</a></li>';
        }
        echo '</ul>';
    }
